...
url = input("Digite a URL do site para download dos sprites: ")
...
if len(sprite_links) > 0:
    print("Links de sprites encontrados:")
    ...
    def download_sprite(sprite):
        ...
        print(f"- {sprite_name} - {sprite_download_link}")
    ...
    print("\n")
    print("Download de sprites iniciado...")

    # Cria um pool de threads para realizar o download dos sprites em paralelo
    with ThreadPoolExecutor(max_workers=8) as executor:
        # Itera sobre as categorias e inicia o download dos sprites em paralelo
    ...
    print("Nenhum link de sprite encontrado na página.")
